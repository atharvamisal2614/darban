...
//           <div className="bg-[url('/darbanimages/darban-rooms-1.jpeg')] hover:scale-105 transition-all duration-500 md:rounded-lg relative h-80 flex flex-col  my-5 bg-center bg-cover">
//             {/* <p className="px-2 border rotate-[270deg] right-1 absolute text-right mt-7 text-white rounded w-fit">
//               View
//             </p> */}
//             <div className="flex-1"></div>
//             <h3 className="text-white text-center py-2 bg-black bg-opacity-10 text-xl">
//               Visit
//             </h3>
//           </div>
//         </Link>
//         <Link data-aos="zoom-in" href={"/blunest/blugarden"} className="md:w-1/2">
//           <div className="bg-[url('/darbanimages/darban-rooms-2.jpeg')] hover:scale-105 transition-all duration-500 md:rounded-lg relative h-80 flex flex-col  my-5 bg-center bg-cover">
            
//             <div className="flex-1"></div>
//             <h3 className="text-white text-center py-2 bg-black bg-opacity-30 text-xl">
//               Visit
//             </h3>
//           </div>
//         </Link>
...
//       <div className="flex flex-col md:flex-row max-w-6xl m-auto gap-5">
//         <Link data-aos="zoom-in" href={"/blunest/bluwater"} className="md:w-1/2 ">
//           <div className="bg-[url('/darbanimages/darban-rooms-3.jpeg')] hover:scale-105 transition-all duration-500 md:rounded-lg relative h-80 flex flex-col  my-5 bg-center bg-cover">
...
//         </Link>
//         <Link data-aos="zoom-in" href={"/blunest/blugarden"} className="md:w-1/2">
//           <div className="bg-[url('/darbanimages/darban-rooms-6.jpeg')] hover:scale-105 transition-all duration-500 md:rounded-lg relative h-80 flex flex-col  my-5 bg-center bg-cover">
...
//       <div className="flex flex-col md:flex-row max-w-6xl m-auto gap-5">
//         <Link data-aos="zoom-in" href={"/blunest/bluwater"} className="md:w-1/2 ">
//           <div className="bg-[url('/darbanimages/darban-rooms-5.jpeg')] hover:scale-105 transition-all duration-500 md:rounded-lg relative h-80 flex flex-col  my-5 bg-center bg-cover">
...
// Presidential Suite
//  </span> at Darban 
//  Resort—an expansive and exclusive{" "}
...
//       {/* Repeat the above structure for additional rooms */}
//     </>
//   );
// };
    ...
    <>
      <div className="flex flex-col md:flex-row max-w-6xl m-auto gap-5" data-aos="fade-up">
        <div className="md:w-1/2 flex flex-col mb-10">
          ...
          <p className="mt-5 text-[18px] font-serif text-green-600 text-justify mb-4 px-4">
            <span className="text-purple-800">Relax</span> in style at Deluxe{" "}
            <span className="text-purple-800">Darban Resort's</span>, featuring{" "}
            contemporary furnishings and a{" "}
            <span className="text-purple-800">cozy ambiance</span>, ensuring a
      ...
      <div className="mt-20 flex flex-col md:flex-row max-w-6xl m-auto gap-5 " data-aos="fade-up">
        <div className="md:w-1/2 flex flex-col mb-10">
          ...
          <p className="mt-5 text-[18px] font-serif text-green-600 text-justify mb-4 px-4">
            <span className="text-purple-800">Indulge</span> in luxury{" "}
            <span className="text-purple-800">with</span> the Premium Deluxe Room at{" "}
            <span className="text-purple-800">Darban Resort,</span> offering{" "}
            upscale <span className="text-purple-800">decor</span> and thoughtful{" "}
        ...
        <div className="md:w-1/2 flex flex-col mb-10">
          ...
          <p className="mt-5 text-[18px] font-serif text-green-600 text-justify mb-4 px-4">
            <span className="text-purple-800">Create memories</span> with loved ones in{" "}
            <span className="text-purple-800">Family</span> Deluxe Room at Darban Resort,{" "}
            designed with <span className="text-purple-800">spacious</span> layouts and{" "}
