...
const Gallery = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col max-w-6xl m-auto py-20 text-center">
        <h2 className=" wow animate__backInUp text-9xl font-bold mb-10 font-lifeSugar bg-gradient-to-r from-purple-900 to-green-300 inline-block text-transparent bg-clip-text">
        Our Gallery</h2>
