      ...
      <AdminLayout>
        <div className="max-w-7xl m-auto  my-10">
          <div className="flex justify-between items-end p-5">
            <h2>{room.title}</h2>
            <button onClick={updatePrices} className="h-fit ">
              Save All Rate Changes
            </button>
          </div>

          <AvailabilityCalender room={room} />
          <div key={room._id} className="p-5">
            <h3 className="mt-10">WeekDay Rates (Mon, Tue, Wed, Thu )</h3>

            <div className="flex border rounded mb-10">
            ...
            <div className="flex border rounded mb-5">
              <div className="w-1/4 p-5 ">
