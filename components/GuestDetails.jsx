        ...
        <div className="flex md:flex-row flex-col gap-10 my-10 ">
          <div className="md:w-2/3">
            ...
            <form id="guest-details" onSubmit={(e) => handleSubmit(e)}>
              <div className="flex gap-5">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    className="outline-none w-full border border-purple-800 rounded p-1"
                  />
                </div>
                <div className="w-1/2">
                  <p>Last Name</p>
                  <input
                    ...
                    required
                    onChange={handleOnChange}
                    className="outline-none w-full border border-purple-900 rounded p-1"
                  />
                </div>
              </div>
              ...
              <p>Special Request</p>
              <textarea
                className="w-full border border-purple-900 rounded p-1 outline-none resize-none"
                ref={requestRef}
                cols="10"
                rows="3"
                onChange={handleOnChange}
          ...
          <div className="md:w-1/3 bg-gradient-to-b from-purple-100 to-green-100 rounded p-5">
            ...
            <button
              type="submit"
              form="guest-details"
              className="my-5 bg-gradient-to-r from-purple-800 to-green-600 rounded w-full"
            >
              Proceed to Checkout
            </button>
            <button
              onClick={() => setPage(0)}
              className="bg-white border border-purple-800 text-green-600 w-full"
            >
              Go Back
            </button>
          </div>
...
//   const [couponObj, setCouponObj] = useState(null);
//   const [hasWeekend, setHasWeekend] = useState(false); // New state to track weekends
...
//     const hasWeekendDate = dates.some((date) => {
//       const day = new Date(date).getDay();
//       return day === 0 || day === 6; // 0 is Sunday, 6 is Saturday
//     });
//     setHasWeekend(hasWeekendDate);
//   };
...
//   useEffect(() => {
//     calculateAmount();
//   }, [adults, child, childTen, couponObj, state]);
...
//                 placeholder="Coupon Code"
//                 className="inp"
//                 disabled={hasWeekend} // Disable input if weekend is present
//                 style={{ cursor: hasWeekend ? "not-allowed" : "text" }} // Change cursor
//               />
//               <p
//                 onClick={() => {
//                   if (!hasWeekend) addCoupon();
//                 }}
//                 className={`cursor-pointer text-primary ${
//                   hasWeekend ? "opacity-50 cursor-not-allowed" : ""
//                 }`}
//               >
//                 Add
//               </p>
